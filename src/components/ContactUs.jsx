  ...
  return (
    <div className='contactussec ' >
      <div className="contactus d-flex flex-column flex-md-row p-4 text-light">
        <h1 className="ms-5 fs-1 mb-4 mb-md-0 o">ContactUs</h1>
        ...
        <div className="detailssec ms-5 p-5 text-light">
          ...
          <p>
            <svg
              ...
              viewBox="0 0 16 16"
            >
              <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11"/>
