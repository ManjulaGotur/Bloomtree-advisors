    ...
    <div className='firstpage'>
      ...
      <div className="content">
        <div className="heading">
          ...
          <p>
            You take care of the core business and we take care of the math. Our
            vision is to cater as a  one-stop solution for all your finance
            related services
          </p>
      ...
      <div className="mainabout">
        <div className="imge ms-5 mt-5">
          ...
          <div className="establish ms-2 ">
            <p>
              Bloomtree Advisors was established with a vision to support the <br />
              functionalities of an organization by complimenting the work of a <br />
              CEO/the founders by acting as their shadow in the finance domain <br />
              of the company. The team comprises of subject matter experts who <br />
              provide professional, results-driven and high-quality advisory <br />
        ...
        <div className="outsource1 mt-5">
          <div className="outsrc">
            ...
            <p className="mt-2">
              ...
              fugiat iste odio, vero, veritatis aut est, autem ipsum dolorum
              facere vel tempore exercitationem. Sint, laborum?
            </p>
          ...
          <div className="consult">
            ...
            <p className="mt-2">
              ...
              eaque autem, dolore veritatis velit corrupti illo ut tempore
              mollitia totam deleniti doloremque blanditiis ipsa fuga!
            </p>
            <button className="btn btn-primary mb-2">Read more -&gt;</button>
          </div>
          ...
          <div className="virtual">
            ...
            <p className="mt-2">
              ...
              ducimus, animi aspernatur hic aperiam et expedita porro voluptas
              placeat libero quo fugiat officia a voluptatum.
            </p>
            <button className="btn btn-primary mb-2">Read more -&gt;</button>
          </div>
        </div>

        <div className="oursource2 mt-5">
          <div className="tax">
            <img
              className="mt-3"
            ...
            <p className="mt-2">
              ...
              impedit aperiam repellendus repellat! Ratione distinctio odio
              molestias itaque nesciunt quasi, minima mollitia aliquam quibusdam
              et.
            </p>
            <button className="btn btn-primary mb-2">Read more -&gt;</button>
          </div>
          ...
          <div className="investor">
            ...
            <p className="mt-2">
              ...
              minus quidem iusto. Dolore quidem labore quia nemo, neque vitae,
              suscipit error eaque numquam iure doloribus?
            </p>
            <button className="btn btn-primary mb-2">Read more -&gt;</button>
          </div>
        </div>
    ...
    <div className='teammates '>
        ...
        <div className="teammember  ">
            ...
            <div className="person1">
                <img src="https://bloomtreeadvisors.com/assets/uploads/team/_MG_4437.jpg" alt="" />
                <h4 className="text-center">Anantha Padmanabha H S</h4>
                <p className="text-center">View Profile</p>
            </div>
            <div className="person2">
                <img src="https://bloomtreeadvisors.com/assets/uploads/team/_MG_4417.jpg" alt="" />
                <h4 className="text-center" >Prathik N P</h4>
                <p className="text-center" >View Profile</p>
            </div>
            <div className="person3">
                <img src="https://bloomtreeadvisors.com/assets/uploads/team/_MG_4473.jpg" alt="" />
    ...
    <div className="contact ">
      <div className="contactdetails ">
        <div className="Contact-us">
          <h1>Contact Us</h1>
          <p>Call us or Visit us for more queries</p>
...
<div className="honest">
    <h2>Honest, Competent and <br /> Always Available</h2>
    <p>
        We have worked with Bloomtree for close to 5 years now, have had
        them as our Advisors for two of our companies and across multiple
        functions. What we have seen is that they have been very helpful
        with whatever issues and questions we have. We appreciate that they
        have been our advisors in all our businesses and have been with us
        from our start and have helped us execute complicated
        local/international transactions while following due process and
        paperwork.
    </p>
    ...
    <p>
        We are pleased with the experience that we enjoyed while working
        with Bloomtree Advisor. Always met the promised deadlines during
        annual GST returns & Internal Audit. The team has always been very
        accessible to help us address & analyze issues that arise during the
        year.
    </p>
    <h3>
    ...
    <p>
        We have been working with them since 2020 and they've handled some
        of our crucial aspects. A young team who has always thought company
        first in every single aspect. If ownership is what you're looking
        for, they're the ones to work with. They are tailor-made to work
